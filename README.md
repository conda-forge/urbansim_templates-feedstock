About urbansim_templates-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/urbansim_templates-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/urbansim_templates-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
```
mamba install urbansim_templates
```
...
pixi add urbansim_templates
# for installing globally
pixi global install urbansim_templates
```
...
It is possible to list all of the versions of `urbansim_templates` available on your platform:
...
```
mamba search urbansim_templates --channel conda-forge
```
...
```
pixi search urbansim_templates --channel conda-forge
```
...
mamba repoquery search urbansim_templates --channel conda-forge

# List packages depending on `urbansim_templates`:
mamba repoquery whoneeds urbansim_templates --channel conda-forge

# List dependencies of `urbansim_templates`:
mamba repoquery depends urbansim_templates --channel conda-forge
```
...
* [@waddell](https://github.com/waddell/)
